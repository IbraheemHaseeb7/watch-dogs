...
function NFTCollectionContainer() {
  ...
  return (
    <div className="w-full flex justify-center items-center flex-col">
      <div className="w-full h-[30rem] overflow-y-scroll max-md:overflow-x-scroll custom-scroll">
        <div className="w-full grid grid-cols-nft-cols max-md:grid-cols-nft-md-cols font-medium text-[12px] mb-5">
          <p>#</p>
          <p>COLLECTION</p>
